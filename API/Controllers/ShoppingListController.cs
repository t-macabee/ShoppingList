...
namespace API.Controllers
{
    public class ShoppingListController : BaseAPIController
    {
        ...
        public ShoppingListController(IUnitOfWork uow, IMapper mapper, DataContext context)
        {
            this.uow = uow;
            this.mapper = mapper;
        ...
        public async Task<IActionResult> CreateShoppingList(int shopperId, string listName)
        {
            ...
            if (await ListExistsForShopper(listName, shopperId))
            {
        ...
        private async Task<bool> ListExistsForShopper(string listName, int shopperId)
        {
